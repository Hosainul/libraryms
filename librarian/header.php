...
require_once '../dbcon.php';
    ...
    $data = mysqli_query($con, "SELECT * FROM `librarian` WHERE `username` = '$librarian_username' ");
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= $librarian_info['firstname'].' '.$librarian_info['lastname']?></span>
                        ...
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="has-child-item close-item">
                                    <a><i class="fa fa-book  <?= $page == 'add_book.php' || 'manage_book.php' ? 'open-item':''?>" aria-hidden="true"></i><span>Books</span></a>
