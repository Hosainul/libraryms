...
session_start();
    if(isset($_SESSION['student_ligin'])){
...
if(isset($_POST['student_register'])){
   ...
   if(empty($firstname)){
       $input_errors['firstname'] = "Firstname field is required!";
   }
   if(empty($lastname)){
       $input_errors['lastname'] = "Lastname field is required!";
   }
   if(empty($email)){
   ...
   if((count($input_errors) == 0)){
    $result =  mysqli_query($con, "INSERT INTO `students`(`firstname`, `lastname`, `roll`, `reg`, `email`, `username`, `password`, `status`, `phone`) VALUES ('$firstname','$lastname','$roll','$reg','$email','$username','$password_hash','0','$phone')");
            ...
            <div class="panel mb-none">
                <div class="panel-content bg-scale-0">
                    <form method="post" action="<?= $_SERVER['PHP_SELF']?>">
                        <div class="form-group mt-md">
                            ...
                            <?php 
                                if(isset($input_errors['firstname'])){
                                    echo '<span class="input_error">'.$input_errors['firstname'].'</span>';
                                }
                            ?>
                        </div>
                        <div class="form-group mt-md">
                            ...
                            <?php 
                                if(isset($input_errors['lastname'])){
                                    echo '<span class="input_error">'.$input_errors['lastname'].'</span>';
                                }
                            ?>
                        </div>
                        <div class="form-group mt-md">
                        ...
                        <div class="form-group mt-md">
                            <span class="input-with-icon">
                                <input type="text" class="form-control" placeholder="Role" name="roll"
                        ...
                        <div class="form-group mt-md">
                            <span class="input-with-icon">
                                <input type="text" class="form-control" placeholder="Registration" name="reg"
                                value="<?= isset($reg) ? $reg: '' ?>">
                                <i class="fa fa-user"></i>
                            </span>
                            <?php 
...
<!--BASIC scripts-->
<!-- ========================================================= -->
<script src="../asets/vendor/jquery/jquery-1.12.3.min.js"></script>
<script src="../asets/vendor/bootstrap/js/bootstrap.min.js"></script>
<script src="../asets/vendor/nano-scroller/nano-scroller.js"></script>
<!--TEMPLATE scripts-->
<!-- ========================================================= -->
<script src="../asets/javascripts/template-script.min.js"></script>
<script src="../asets/javascripts/template-init.min.js"></script>
